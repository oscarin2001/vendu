...
import { createManager } from "../../../mutations/crud/create/create-manager";
import { updateManager } from "../../../mutations/crud/update/update-manager";
import { deleteManager } from "../../../mutations/crud/delete/delete-manager";
import { toggleManagerStatus } from "../../../mutations/crud/status/toggle-manager-status";

/**
 * Hook for manager CRUD operations
 * Handles create, update, delete and status toggle operations
 */
export function useManagerCrud(tenantId: string, onManagerChange?: () => void) {
