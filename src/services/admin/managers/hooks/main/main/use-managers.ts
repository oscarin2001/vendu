...
import { useManagerCrud } from "../../actions/crud/use-manager-crud";
import { useManagerAssignments } from "../../actions/assignments/use-manager-assignments";
...
export function useManagers(tenantId: string) {
  ...
  // CRUD operations
  const { createManager, updateManager, deleteManager, toggleManagerStatus } =
    useManagerCrud(tenantId, refresh);
