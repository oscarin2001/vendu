...
import { ManagerFiltersState } from "@/services/admin/managers";

interface ManagersFiltersProps {
  filters: ManagerFiltersState;
  onFiltersChange: (filters: ManagerFiltersState) => void;
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Create Button */}
        <Button onClick={onCreateManager} className="shrink-0">
