...
INSERT INTO "new_tbemployee_profiles" ("FK_auth", "FK_branch", "FK_company", "FK_createdBy", "PK_employee", "birthDate", "ci", "contractType", "createdAt", "deletedAt", "firstName", "hireDate", "homeAddress", "lastName", "phone", "salary") SELECT "FK_auth", "FK_branch", "FK_company", "FK_createdBy", "PK_employee", "birthDate", "ci", "contractType", "createdAt", "deletedAt", "firstName", "hireDate", "homeAddress", "lastName", "phone", "salary" FROM "tbemployee_profiles";
